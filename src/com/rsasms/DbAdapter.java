...
public class DbAdapter {
    ...
    public void loadDb(){
        ...
        // messageStore
        this.prepare(mContext.getString(R.string.messageStore_database), mContext.getString(R.string.messageStore_table), 
        		new BigInteger(mContext.getString(R.string.messageStore_version)).intValue(), 
        		mContext.getString(R.string.messageStore_columns), mContext.getString(R.string.messageStore_updates).split(";"), 
        		mContext.getString(R.string.messageStore_indexlist).split(";"));
        
        // recipientStore
        this.prepare(mContext.getString(R.string.recipientStore_database), mContext.getString(R.string.recipientStore_table), 
        		new BigInteger(mContext.getString(R.string.recipientStore_version)).intValue(), 
        		mContext.getString(R.string.recipientStore_columns), mContext.getString(R.string.recipientStore_updates).split(";"), 
        		mContext.getString(R.string.recipientStore_indexlist).split(";"));
        
        // wordStore
        this.prepare(mContext.getString(R.string.wordStore_database), mContext.getString(R.string.wordStore_table), 
        		new BigInteger(mContext.getString(R.string.wordStore_version)).intValue(), 
        		mContext.getString(R.string.wordStore_columns), mContext.getString(R.string.wordStore_updates).split(";"), 
        		mContext.getString(R.string.wordStore_indexlist).split(";"));
        
        // logStore
        this.prepare(mContext.getString(R.string.keyStore_database), mContext.getString(R.string.keyStore_table), 
        		new BigInteger(mContext.getString(R.string.keyStore_version)).intValue(), 
        		mContext.getString(R.string.keyStore_columns), mContext.getString(R.string.keyStore_updates).split(";"), 
        		mContext.getString(R.string.keyStore_indexlist).split(";"));
    ...
    public void prepare(String database, String table, int version, String createcolumns, String[] updatesql, String[] indexsql) {
		...
		d += TABLE_COLUMNS;
		d += ", " + COL_TIMECREATE + " INTEGER";
		d += ", " + COL_TIMEUPDATE + " INTEGER";
	...
	public DbAdapter prepare() throws SQLException {
    	...
    	//Log.i(TAG,"prepare() DatabaseHelper.getWritableDatabase()");
